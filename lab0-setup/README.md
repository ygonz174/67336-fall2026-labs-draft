...
What it does
ls
List all files and folders in your current location
cd folder
Change into a folder (e.g. cd Documents)
cd ..
...
rm file
Delete a file (permanent, be careful!)
pwd
Print your current location (full path)
...
You write a shortbread recipe. The yield says 12 cookies.
You bake it and discover it actually makes 3. You fix the file and commit.
You taste them and realize 3 was also wrong, it actually makes 24. You fix it and commit again.
Learning Objectives
...
Name your repository lab0-setup.
Set visibility to Private.
Do NOT check any boxes for README, .gitignore, or license — leave the repo empty.
Click "Create repository" and leave the page open — you will need the URL in Step 11.
...
npm -v
Expected: 10.9.2
Warning: If the versions do not match, close your terminal, reopen it, and run the commands again before troubleshooting further.
...
Warning: Make sure your repo is private, has at least 3 commits visible, and add shihongh, ygonz174, and lillian-zhao as collaborators so we can grade your lab.
...
Save staged files with a descriptive message
git log --oneline
View a compact commit history
git diff <file>
See line-by-line changes not yet staged
...
Disconnect from the current remote
git branch <name>
Create a new branch
git checkout <branch>
Switch to a branch
